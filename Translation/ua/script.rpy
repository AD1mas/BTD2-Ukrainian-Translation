Idefine p = DynamicCharacter("player_name", window_background="dialoguebox_player.png")
...
label splashscreen:
    ...
    show text "{=endslate_title}{size=90}{color=#cc0000}ДИСКЛЕЙМЕР: 18+, містить горор та NSFW{/color}{/size}{/=endslate_title}\n{vspace=10}{size=30}ПОПЕРЕДЖЕННЯ:{/size}\nепілепсія, трясіння екрану\nграфічна жорстокість\nсексуальний контент\nсцени зґвалтування\nтемні теми\n{vspace=10}{size=30}ЛИШЕ 18+!{/size}{vspace=20}\nРозширений список попереджень:{a=http://www.boyfriendtodeath.com/btd-2-fresh-blood.html}{color=#ffffff}сайт{/color}{/a}." with dissolve
    pause
    scene endslate_clean with dissolve
    show text "Всі зображені персонажі та дії є вигаданими.\n{vspace=20}Всі дії мають наслідки, але це не історія тріумфу добра над злом, ні: це історія крізь жахи людської свідомості: часом жорстокі, часом лагідні, але все ще жахи.\n{vspace=20}Якщо ви почуваєтесь погано, зробіть перерву та закрийте гру.\n{vspace=20}{color=#cc0000}Гра створена, щоб жахати та захоплювати, а не щоб зашкодити.\nПодбайте про себе!{/color}" with dissolve
    pause
    return
...
$ player_name = renpy.input("Як тебе звати?",length=10)
...
p "Хочеться провести десь час сьогодні"
n "Я увімкнув свій комп'ютер"
n "Вже пізно, проте ще мають бути відчинені заклади"
call screen webpage
...
$ vincent_name = "???"
n "Старий пошарпаний більярдний зал не був найкращим місцем для розваг, але в дупі грало бажання пригод"
n "Я одягнувся у все чорне та оглянув себе"
n "Я не хотів виділятися, це мало б допомогти"
n "Хто знає?"
scene alleyway with dissolve
n "Я вийшов з свого дому та попрямував у центр міста"
n "Щойно я приїхав до закладу, я пройшов усередину"
scene poolhall with dissolve
play music "vincent/Vincent_Poolhall.mp3"
n "Оглянувши залу, я відчув, що це далеко не те місце, де хотілося б бути"
n "Я почувався зайвим"
n "Хоч я і намагався бути обережним, проте все одно випадково вдарявся об великих чоловіків і непристояно одягнених жінок"
p "Ой... вибачте"
show farz
$ fbase,fexp = 1,1
n "Невисокий хлопець насупив брови, дивлячись мені в очі"
$ farz_name = "???"
farz "Ох, ти тепер ще й вибачаєшся?"
farz "А може треба було спершу під ноги дивитись, чмо лупате?"
menu:
    "\"Вибач, не помітив тебе там знизу\"":
        $ farz_love -= 10
        $ temper +=10
        $ fexp =2
        farz "Що ти блять щойно сказав, вилупок?!"
        n "Раптом він вдарив мене кулаком у живіт з усієї сили" with vpunch
        $ health -=5
        n "Я відчув, як удар вибив повітря з мене, коли я притиснув руку до живота від болю, мимоволі нахилившись перед ним"
        n "Я був спантеличений, що нікому навколо не було до цього діла: ніхто навіть не думав втрутитися та допомогти мені"
        farz "Це тільки початок. Готуйся, я зараз з тебе всі кишки повириваю, щоб ти довго задихався у власній крові, суко"
        n "Він загрозливо наблизився"
    "\"Вибач, я випадково, я не хотів тебе образити\"":

        $ farz_love += 10
        farz "Пффф"
        farz "Слідкуй за тим, щоб цього більше не сталось"
        n "Він виглядав дуже роздратованим та незадоволеним, як я оглядав його обличчя"
        farz "На що витріщаєшся?"
        n "Його злість лише зростала. Він стиснув руку в кулак, наблизившись"
    "\"Мені так похуй, що тобі і не снилось\"":

        $ farz_love -= 5
        farz "Що ти блять щойно сказав?"
        p "Я сказав, що мені похуй, бро. Від'їбись"
...
show farz:
    subpixel True
    xpos 550
n "Високий, міцний хлопець з широкими плечима підійшов до нас"
n "Люди розступалися перед ним, пропускаючи його вперед. Було очевидно, що його тут поважають"
n "Він був тим, з ким ніхто в барі не хотів мати проблем"
vincent "Що ви, лайдаки, робите?"
vincent "Не можна битися просто посеред закладу"
vincent "Не змушуй цих свиней знову встромляти свої носи не у свої справи..."
vincent "Зрозумів?"
n "Низький хлопець затих, опустивши погляд"
$ farz_name = "Фарц"
$ persistent.character_unlock_farz = True
vincent "Фарц."
n "Фарц поглянув у очі більшого хлопця, швидко відвівши погляд"
farz "Ох, та добре!"
$ fexp =2
farz "Тобі дуже пощастило, що Вінсент тут"
$ vincent_name = "Вінсент"
$ persistent.character_unlock_vincent = True
hide farz
show vincent at center
$ vbase,vblush,vexp = 2,0,3
if player_name.lower() == "rot" or player_name.lower() == "рот":
    n "Вінсент відвів погляд. Було видно, що йому дуже некомфортно"
    $ vbase,vblush,vexp = 2,0,2
    vincent "Ти виглядаєш таким лагідним..."
    vincent "Так, ніби хтось типу мене..."
    vincent "Невдовзі тебе зламає"
    p "Я не вірю, що ти на таке здатен"
    $ vbase,vblush,vexp = 2,1,1
    vincent "Ти не можеш бути в цьому впевнений"
    p "Я вірю в це"
    vincent "Який же бовдур..."
    p "Можливо"
    p "Але все ще вірю, що ти мені не нашкодиш"
    vincent "Можливо ненавмисне"
    $ vincent_love += 10
    n "Вінсент продовжував червоніти"
else:
    n "Я був дуже вдячний йому, що він втрутився в нашу перепалку, проте він виглядав не дуже зацікавленим в мені зараз"

$ vbase,vblush,vexp = 2,0,3
menu:
    "\"Дуже дякую тобі\"":
        $ vincent_love += 10
        vincent "Хочеш подякувати мені?"
        $ vbase,vblush,vexp = 2,0,1
        n "Він говорив тим самим грубим тоном, що й раніше, але знову перевів погляд на мене"
        vincent "Тоді можеш подякувати мені більше, ніж словами"
        n "Я відчув, ніби в мене щось застрягло в горлі від цього"
        $ vbase,vblush,vexp = 2,0,5
        vincent "Може навіть можеш використати свій ротик~"
        n "Він наблизився, а я відступив назад"
        vincent "Закладаюся, що в тебе ніколи не було справжнього чоловіка, як я"
        $ vbase,vblush,vexp = 2,0,4
        vincent "Хочеш спробувати на смак мій член?"
        n "Я лише продовжував червоніти від аж настільки відвертої прямолінійності"
        vincent "Пропозиція в силі тільки якщо ти СПРАВДІ хочеш мені віддячити за те, що я врятував твою дупу"
        n "Він перестав наближатися, схрестивши руки на грудях"
    "\"Я б і сам зміг впоратись\"":

        $ vincent_love -=20
        $ temper += 10
        $ vbase,vblush,vexp = 2,0,1
        vincent "АХАХ, та невже?"
        n "Було видно, що він не сильно вірив в мою силу"
        p "Не думаю, що цей гном міг би зі мною щось зробити"
        n "Я намагався звучати грубим та впевненим, проте невпевнений тон мого голосу мене видавав"
        $ vbase,vblush,vexp = 2,0,5
        vincent "Чувак, ти його взагалі не знаєш"
        vincent "Він клятий міцний горішок, якого фіг розколеш"
        n "Хлопець посміявся, хижо дивлячись на мене"
        vincent "І ти просто щасливчик, що ВІН не встигнув тебе зламати"
    "-Промовчати-":

        $ vincent_love -=10
        $ temper += 10
        n "Я не був впевнений, що можна було сказати в такій ситуації, тож я промовчав, дивлячись на нього"
        vincent "В мене щось на обличчі?"
        n "Він насупив брови, дивлячись на мене зверху вниз, що я некомфортно закашлявся"
        vincent "Можливо, тебе турбує відсутність чогось на моєму обличчі?"
        n "Облизавшись, він нахилився до мене, простягнувши свої руки до мене"
        n "Він поклав свої руки на мої плечі, що я аж здригнувся від страху того, що наближалось" with vpunch
        n "Холодний піт стікав по моїй потилиці, як я відскочив від нього"
        $ vbase,vblush,vexp = 2,0,6
        vincent "Гей, що ти тут розстрибався, зайчику?"
        vincent "Впевнений, ти лише хотів роздивитися поближче мої гарні риси обличчя"
        n "Вінсент жартівливо штовхув мене у плече та посміявся"

if player_name.lower() == "andi" or player_name.lower() == "анді" or player_name.lower() == "енді":
    vincent "Гарний пірсинг"
    n "Я доторкнувся до різних сережок та каф на своєму вусі, щиро посміхнувшись йому"
    n "Я відчував, як легко червонію"
    p "Оу... так, на сусідній вулиці є гарний салон для цього"
    n "Він повернув голову, ніби дивився вниз по вулиці, де мав бути тату-салон."
    n "Він кивнув, посміхаючись"
    vincent "Так, знаю. Справді гарне місце"
    n "Я прикусив свою губу, намагаючись знайти більше спільних тем з ним"
$ vbase,vblush,vexp = 2,0,6
vincent "Виглядаєш так, ніби тобі є, що сказати"
vincent "Говори все, що спадає тобі на думку відразу, як це роблю я"
vincent "Інакше хтось типу мене може помилково прийняти це за тупе витріщання"
n "Хіба я витріщався?"
n "Я навіть не був впевнений"
n "Але навіть якщо так, то у нього справді було на що витріщатись"
n "Він був масивний та м'язистий, вкритий величезною кількістю шрамів. Було видно, що люди тут його боялися"
menu:
    "-Представитись-":
        $ vincent_love +=5
        jump vincent_sweet_mc
    "\"А звідки в тебе ці шрами?\"":
...
p "Мене звуть %(player_name)s"
n "Я намагався звучати якнайбільш ввічливо"
if player_name.lower() == "farz" or player_name.lower() == "фарц":
    $ vbase,vblush,vexp = 2,2,8
    vincent "Бля, у вас реально однакове ім'я з ним"
    p "Так, воно не дуже поширене.. хе-хе"
    vincent "Звісно ні"
    $ vbase,vblush,vexp = 2,0,9
    $ vincent_love +=10
vincent "Не думаєш, що тобі варто було б поговорити ще з кимось у цьому барі?"
vincent "Зважаючи на це, як ти витріщаєшся на моє обличчя..."
vincent "Впевнений, що тут знайдеться достатньо гідних чоловіків, що з радістю зануряться в тебе по самі яйця"
n "Вінсент виглядав задоволеним, говорячи про генгбенг з нами та рештою"
n "Я прикусив свою губу від такого"
$ vbase,vblush,vexp = 2,0,7
p "Слухай... може це не те, по що я сюди прийшов!"
$ vbase,vblush,vexp = 2,0,5
vincent "Тоді ти точно прийшов не в той бар і почав говорити не з тим хлопцем"
vincent "Я не збираюся бути з тобою добрим"
vincent "Я не буду ставитися до тебе, як до тендітної квіточки"
$ vbase,vblush,vexp = 2,0,4
vincent "Я блять тебе хочу розірвати як йобана тварина, якою я і є всередині"
$ vbase,vblush,vexp = 2,0,5
...
menu:
    ...
    "\"Що ти маєш на увазі?\"":
        ...
        $ vincent_love -=5
        $ temper += 10
        vincent "Я говорю, що хочу тебе прямо зараз кинути на стіл..."
        vincent "І відтрахати прямо перед усіма цими людьми"
        n "Дехто в барі озирнувся, уважно споглядаючи на нас і слухаючи його монолог"
        n "Вінсент почав наступати на мене, і я зробив крок назад"
        vincent "Вже не вперше. Вони люблять робити ставки, скільки часу пройде, поки я не кінчу"
        vincent "Ми можемо займатися цим всю ніч~"
        n "Відступаючи від нього, я притулився спиною об холодну стіну позаду"
        p "Б-будь ласка.. не треба.."
        $ vbase,vblush,vexp = 2,0,8
        n "Вінсент оскалився, хижо дивлячись на мене, наблизивши свою голову до моєї"
        vincent "Проте сьогодні не дуже хочу влаштовувати для цих людей шоу"
        vincent "Розставив пріоритети. Викупаєш, бро?"
        $ vbase,vblush,vexp = 2,0,4
        n "Дуже близько дивлячись на мене, він облизався, гладячи мене по щоці"
        vincent "Не думаю, що в тебе на це є час"
        n "Вінсент відштовхнувся від стіни і відвернувся від мене"
        $ vbase,vblush,vexp = 2,0,6
        n "Він хоче піти від мене?"
        menu:
            "\"ЧЕКАЙ!\"":
                $ vincent_love +=5
                $ temper +=10
                $ vbase,vblush,vexp = 2,0,1
                vincent "..."
                vincent "Ти блять жартуєш зі мною?"
                vincent "Що ти щойно сказав?"
                vincent "Я попереджував - я не збираюсь бути з тобою ніжним"
                n "Я вдивлявся на нього, намагаючись знайти правильні слова"
                n "Вінсент зупинився, оглядаючи мене з ніг до голови"
                $ vbase,vblush,vexp = 2,0,6
                n "Так, ніби задумався про щось дуже збочене"
                vincent "Хочеш секс на одну ніч?"
                $ vbase,vblush,vexp = 2,0,4
                n "Вінсент нахилив голову набік, на обличчі з'явилася широка посмішка"
                p "Ц-це... це не те, що я сказав!"
                n "Вінсент поклав руку мені під підборіддя і підняв мою голову, змушуючи мене дивитися на нього"
                $ vbase,vblush,vexp = 2,0,9
                vincent "Справді?"
                vincent "Твоє обличчя говорить протилежне, малий"
                jump vincent_consensual_sex
            "-Втекти з цього місця якомога швидше-":
                $ vincent_love -=10
                jump vincent_left_alone
...
if player_name.lower() == "farz" or player_name.lower() == "фарц":
    p "...М-можливо я цього все таки хочу"
    n "Я вимовив, аж заїкаючись"
    $ vbase,vblush,vexp = 2,2,4
else:
    p "...Можливо я цього все таки хочу"
    $ vbase,vblush,vexp = 2,0,6
vincent "СПРАВДІ?"
$ vbase,vblush,vexp = 2,0,6
n "Він подивився на інших хлопців у барі, один з яких швидко відвів від нього погляд"
vincent "В тобі більше відваги, ніж у всіх них"
n "Вінсент розглядав моє обличчя, а я лише червонів дедалі сильніше"
vincent "Я поважаю тих, хто просить те, чого хоче"
n "Він простягнув свою руку до мене, а я поклав свою руку на неї"
n "Його рука була дуже м'язистою, широкою вкритою шрамами та широкими венами"
n "Здавалося, що ми доїхали до його будинку за лічені секунди"
scene vincent_bedroom_night with fade
show vincent
$ vbase,vblush,vexp = 1,1,4
play music "vincent/vincent_sex.mp3"
n "Я відчував, як його тіло тиснуло на мене, поки він притискав мене до стіни."
n "Він поклав свої руки на мої бедра, міцно стискаючи мої сідниці своїми грубими руками"
n "Я видав задоволений тихий звук, схожий на стогін, коли він поцілував мою шию"
n "Його гарячий язик ковзав моєю шкірою"
vincent "Ти блять божевільний?"
n "Він прошепотів мені це своїм звичним низьким та дуже грубим голосом"
n "Він взяв мене рукою за шию, піднявши над підлогою"
vincent "Я тебе можу зламати як тонку гілочку одним простим рухом"
n "Він стиснув моє горло сильніше, поки я дихав короткими уривчастими подихами"
n "Вінсент послабив хватку, поклавши одну руку мені під сідниці"
vincent "Але не хвилюйся, я цього не зроблю... принаймні поки що"
n "Він обхопив мою дупу своїми руками, притиснувши мене до стіни своїм масивним тілом, притримуючи знизу"
n "Його член стояв на повну, і я відчував, як він треться об мій прохід"
n "Він глибоко збуджено дихав, боляче вкусивши мене за шию. Його зуби впивались у мою шкіру, викликаючи кров"
n "Я швидко та дихо стогнав від болю йому на вухо, міцно обіймаючи його своїми руками"
vincent "Який солодкий звук.. мені це подобається"
n "Він говорив ніби не до мене, просто насолоджуючись передчуттям того, що наближається"
n "Він терся своїм тілом об моє, ніби намагався трахнути мене крізь свої джинси"
n "Так дразнив мене, ніби підготовлюючи до того, що він зі мною зробить"
$ vbase,vblush,vexp = 1,1,6
vincent "Я блять зроблю тебе своєю сукою"
$ vincent_love +=10
$ vbase,vblush,vexp = 7,1,4
n "Він дістав мисливський ніж зі своїх штанів, піднісши його до мого паху"
menu:
    "\"Навіть не смій, придурок\"":
...
vincent "Ох.. ти справді будеш вказувати мені, що робити?"
n "Він притиснув свого мисливського ножа до моїх джинсів та трусів"
$ health -=10
n "Глибоко дихаючи мені на вухо, він сильно натиснув ним, розрізавши мої труси та зупинившись, коли гостре лезо увійшло всередину" with vpunch
n "Я гучно закричав, через що він затулив мені рота своєю долонею, захопивши мою шию між своєю рукою та біцепсом"
$ vbase,vblush,vexp = 7,0,2
vincent "Ти був веселим, але зараз, здається, втрачаєш свій запал"
$ vbase,vblush,vexp = 7,0,5
n "Я відчував, як гарячі сльози котяться по моєму обличчю і стікають на його руку, а він міцно тримає мене на місці"
n "Він натиснув ножем глибше, а я чинив опір, намагаючись вдарити його своїми ногами"
vincent "Спробуймо щось цікавіше... хм"
n "Він дістав наручники зі своєї кишені, затягнувши їх на моїх зап'ястях"
vincent "Ти нікуди не підеш, ти занадто солодкий, щоб тебе відпускати~"
$ health -=5
n "Він різко відпустив мене, через що я аж від паніки впав на підлогу" with hpunch
p "Що ти блять робиш?!"
n "Я закричав, я був у паніці, це було занадто для мене. Я лише сподівався, що мене хтось почує і врятує"
vincent "Роблю все, що хочу"
n "По-тваринному загарчавши, він нахилився до мене та вийняв ніж"
$ health -=5
n "Я гучно простогнав, ковтаючи якомога більше кисню, ніби від цього залежало моє життя. Тупий біль поширився по моєму тілу"
n "Він сів на мої ноги, з легкістю шматуючи мій одяг, ніби папір"
n "Я почав плакати одночасно і від болю, і від того, яких збитків він мені завдав. Мої улюблені штани за 40 гривень..."
n "Він це робив настільки грубо, що після нього на моєму тілі залишилися купа подряпин від його пазурів"
n "Він притиснув мій тулуб до підлоги, вставши на одне коліно та нахилившись до мого живота"
$ vbase,vblush,vexp = 1,0,5
n "Вінсент палко поцілував рану, яку щойно зробив, від чого я аж здригнувся"
vincent "Ох.. така свіжа і така ніжна, така крихка..."
n "Він говорив напівпошепки, просовуючи язика всередину порізу. Я дуже сильно тремтів від нових почуттів"
$ sanity -=10
n "Він проходив все глибше. Я видав гучний крик, коли вже не міг терпіти"
$ sanity -=10
n "Він проігнорував мої звуки, лише міцніше стиснувши своїми м'язистими та сильними руками моє тендітне тіло, злизуючи кров з рани"
$ vbase,vblush,vexp = 1,0,5
n "Невдовзі закінчивши, він облизався та нахилив свою голову над моїм обличчям. Його пронизливий хижий погляд змушував мене тремтіти ще більше"
$ vbase,vblush,vexp = 1,0,4
vincent "З тебе вийде дуже гарний обід... Я давно не куштував аж настільки смачну здобич~"
$ vbase,vblush,vexp = 1,0,5
n "Не прикладаючи особливих зусиль, він розірвав мої вже надрізані джинси, а потім і труси"
vincent "Але спершу.."
n "Я не міг рухатися, адже був паралізованим страхом. Я почув звук, як він знімає ремінь і опускає свої штани"
n "Його стояк терся об мене, а невдовзі він зміг зайти всередину"
n "Зібравшись з думками, я намагався відкинути його своїми руками та ногами"
$ temper +=10
n "Я чув його гучні задоволені стогони, як він рухався всередині, грубо пробиваючи собі шлях все далі"
$ health -=5
n "Він міцно притиснув мене до себе своєю вільною рукою. Я відчув, як його кігті зайшли мені під шкіру"
$ health -=5
n "Я задихався. Мій голос вже охрип від криків"
n "Його тіло було дуже гарячим на дотик, що контрастувало з холодною підлогою піді мною. Це спонукало мене триматися поближче до нього"
n "Я намагався вибратися з наручників, проте з кожним рухом руками вони стискали мене тільки сильніше"
n "Вінсент з часом ставав тільки грубішим, а я почув, як моє тіло не витримує його темпу"
p "А-аах..."
n "Я видав тихий звук, який відразу ж перебив своїм ричанням Вінсент, увійшовши всередину по самі яйця та притискаючи мене до себе дуже сильно"
n "Я відчув тепло всередині та те, як задоволено він стонав мені на вухо, а опісля почав втрачати свідомість"
vincent "Аах... як ти? Все добре там знизу?"
vincent "Ох ти ж блять"
vincent "Можливо мені варто бути м'якшим зі своїми іграшками"
n "Я чув, як Вінсент щось говорить до мене та намагається повернути мене в свідомість, проте у очах та у вухах все рябіло, і зрештою я повністю відключився"
scene black
with fade
...
$ vincent_love +=10
p "В-вінсент.. б-будь ласка.."
vincent "Гей, я тобі нічого не зроблю, заспокойся"
vincent "Ну.. принаймні нічого дуже поганого"
vincent "Ти ж не будеш кінкшеймити хлопця за те, що він любить дуже грубий секс?"
n "Вінсент штовхнув мене на своє ліжко і починав роздирати мої джинси"
p "Агов, якщо ти їх розірвеш - потім купиш нові!"
n "Його погляд сконцентрувався на моїх очах"
$ vbase,vblush,vexp = 7,1,4
n "Він тихо посміявся грубим голосом"
vincent "Я блять куплю тобі, що забажаєш, не псуй момент, суко"
n "Він розірвав мої джинси повністю, відкинувши їх убік. Він перестарався, тому лишив на мені ще більше подряпин"
n "Він подивився на невеликі порізи і провів язиком по подряпинах, змусивши мене вигнути свої стегна"
vincent "Тобі не дуже боляче?"
n "Я кивнув, почервонівши. Моє тіло тремтіло від передчуття того, що він зараз зі мною зробить"
p "Н-не зупиняйся, будь ласка.."
vincent "Тобі не треба мені повторювати двічі, моя слухняна омежка"
n "Він, на диво, обережно скинув з мене залишки одягу та нижню білизну"
$ vbase,vblush,vexp = 1,1,4
n "Я почервонів від такого, рефлекторно намагаючись закрити найінтимніші місця руками"
n "Вінсент схопив мої руки, перемістивши їх над моєю головою. Я відчув, як він притулився носом до моєї шиї і обережно лизнув"
vincent "Не ховайся..."
n "Він почав тертися своїм масивним членом об мій пах, до болю стиснувши мої руки"
vincent "Кричи гучніше, мені це подобається"
n "Він видав гучний низький рик. Це не звучало як щось, що може сказати людина, це більше нагадувало ричання вовка"
$ vbase,vblush,vexp = 1,1,10
n "Я гучно стогнав від його рухів, аж допоки він з грубою силою не притулився своїми бедрами до мене, вдавлюючи мене своєю вагою у тепле ліжко"
p "ВІНСЕНТ!!~ ААААХХ..!~"
n "Мій голос теж тремтів, як раптом він перервав мене, схопивши за шию та несильно стиснувши її. Він не душив мене, лише нагадував, що саме він тут головний"
n "Оскалившись, він показав свої гострі зуби та наблизився своїм ротом до мого. Його тіло стало ще більш гарячим, поки він лежав на мені"
n "Наші язики сплелись між собою, як раптом він знову почав рухатися всередині мене. Цього разу вже більш лагідно і не так боляче"
n "Моє тіло ніби палало від того, як сильно він кінчив мені всередині та притискався своїми м'язами до мене. Я так добре відчував його силу на собі"
$ vbase,vblush,vexp = 1,1,6
vincent "Охх.. давно мені не було так добре, сучка"
if player_name.lower() == "farz" or player_name.lower() == "фарц":
    vincent "Ти всередині такий знайомий.."
    n "Він тихо застогнав, коли я погладив його волосся"
    n "Він притулив мене поближче, міцно обіймаючи своїми сильними руками. На диво, я почувався таким радісним та спокійним, хоч всередині все палало"
n "Вінсент ліг на спину, тримаючи мене на собі. Я відчув, з якою насолодою він нюхає моє волосся, а потім шию"
vincent "Ох блять, нам треба буде зайнятися цим ще раз. З тобою ніколи не стане нудно"
p "Хе-хе.. погоджуюсь"
n "Я почувався виснаженим після такого, тож, заплючивши очі, я відразу вирубився у його обіймах"
scene black with dissolve
jump vincent_day1_consenual

label vincent_pushy_mc:
vincent "З ними я виглядаю загрозливо, еге ж?"
vincent "Попри те, як би я не хотів виглядати гарним красенем..."
vincent "Шрами більше показують те, ким я є всередині"
vincent "Ще питання, малий?"
p "Ні, немає"
vincent "Тож що ти робиш тут?"
vincent "Не виглядає так, що ти тут тільки щоб знайти когось на 1 ніч"
menu:
    "\"Та просто хочу збухатися до втрати пульсу\"":
        $ vincent_love +=5
        jump vincent_get_drunk
    "\"Не впевнений... мабуть, я краще піду\"":
        $ temper +=10
        vincent "Оу... Мабуть так, для тебе це буде найбезпечніший варіант"
        vincent "Ти не дуже вписуєшся у атмосферу цього місця"
        n "Він байдуже розвернувся та пішов від мене"
        n "Як би мені не хотілося це визнавати..."
        n "Він повністю мав рацію"
        n "Я видихнув, озирнувся навколо та попрямував до виходу на вулицю"
        jump vincent_left_alone
...
$ vbase,vblush,vexp = 2,0,1
if player_name.lower() == "farz" or player_name.lower() == "фарц":
    vincent "Ти хоч колись пив, моя маленька омежка?"
else:
    vincent "Ти хоч колись пив?"
n "Вінсент штовхнув мене плечем, проходячи повз"
n "Я прикусив свою губу та глянув на нього"
p "Та я тебе легко переп'ю!"
n "Вінсент зупинився та поглянув на мене здивовано"
n "Він загрозливо підійшов до мене назад, штовхнувши мене в стіну та вдаривши рукою біля моєї голови. Його тіло нависло наді мною"
n "Я аж здригнувся від цього поштовху"
n "Наляканий, я повільно поглянув на вм'ятину, яку він залишив у гіпсокартонній стіні"
$ vbase,vblush,vexp = 2,0,2
vincent "Ти блять в ділі"
vincent "Я за все заплачу"
vincent "Можу собі дозволити поглумитися з твого его, коли ти вже не витримуватимеш"
n "Вінсент взяв мене за руку, міцно стиснувши, та повів за собою"
n "Я швидко глянув на стіну за собою та пройшов за ним, не сильно чинячи опір"
n "Він відпустив мене, коли ми дійшли до бармена, і я сів на високий стілець поруч з ним"
$ vbase,vblush,vexp = 2,0,9
unknown "Не вбий цього малого, Вінсент. Мені вистачило минулого разу"
$ vbase,vblush,vexp = 2,0,8
vincent "Побачимо, хто він є всередині, хе-хе~"
$ vbase,vblush,vexp = 2,0,5
n "Вінсент обережно погладив моє волосся, по-хижому всміхаючись, поки розглядав риси мого обличчя"
vincent "Я стійкий до випивки, багато можу витримати. Думаєш, зможеш тримати такий же темп?"
n "Я невпевнено взяв шот, який мені протягнув бармен, вже жалкуючи, що вв'язався у це"
n "Я зробив ковток, поставивши склянку на стіл назад"
n "Моє горло ніби палало - скільки вони туди додають алкоголю?!"
$ vbase,vblush,vexp = 2,1,5
n "Коли я глянув на Вінсента, він випив вже свою третю чарку"
n "Я взяв свою наступну, раптом відчувши, як масивна рука цього хлопця обіймає мене ззаду, притискаючи поближче"
$ vbase,vblush,vexp = 2,1,6
n "Він підтягнув мене до свого гарячого тіла, всміхаючись"
vincent "Відчуваєш це, малий?"
n "Я відмахнувся від нього, посміхаючись у відповідь. Я намагався здаватися впевненим"
$ vbase,vblush,vexp = 2,1,6
p "Навіть не близько!"
if player_name.lower() == "farz" or player_name.lower() == "фарц":
    vincent "Хах, то ти справді багато п'єш?"
    p "Інколи.. в мене насправді висока толерантність до алкоголю"
    n "Вінсент погладив мене по голові ще раз"
    vincent "Ну добре, добре~"
n "Я випив ще один шот"
n "Все вже почало розпливатися в моїх очах, ставало нечітким та ніби ефемерним"
vincent "Не хочеш піти з цього місця до мене?"
$ vbase,vblush,vexp = 2,1,4
p "... Ходімо, бро"
n "Я встав, проте було складно стояти через тяжке сп'яніння. Добре, що він стояв ззаду і міг спіймати мене прямо у свої м'які обійми"
n "Він з легкістю підтягнув мене ближче, взявши на руки"
n "Він щось сказав бармену, проте мені вже було байдуже. Я просто обіймав його у відповідь, занурившись носом у його шию"
n "Він пахнув потом та алкоголем, проте я не мав нічого проти: це був приємний запах"
scene vincent_bedroom_night with dissolve
show vincent
$ vbase,vblush,vexp = 1,1,9
$ vincent_dayzero_sex = True
n "Пройшло небагато часу, як він приніс мене до себе додому"
n "Я не міг думати про щось чітко, дивлячись, як він скидає мій одяг"
n "Він був дуже грубим зі мною, міцно тримаючи, проте я не заперечував."
$ vbase,vblush,vexp = 1,1,10
n "Я тихо стогнав, насолоджуючись його теплом всередині та зовні. Він був так близько, його велике тіло втискало мене в ліжко"
n "Я не міг зосередитись, просто приймаючи все, що він робить зі мною"
scene black with fade
n "Мої стогони стали гучнішими, коли я відчув, як він кінчає всередину. Мій оргазм настав приблизно у цей же час"
n "Він міцніше стиснув мою шию, видавши задоволене ричання, поки в мене в очах все чорніло"
...
n "Нижче по вулиці було ще якесь кафе"
n "Я попрямував саме туди"
n "Я тяжко видихнув, поки ходив поміж вулиць"
n "Аж раптом відчув щось на своїй шиї. Рука Вінсента міцно стиснула її, перекриваючи доступ до кисню" with hpunch
$ vbase,vblush,vexp = 6,0,5
$ health -=5
show vincent
$ fbase,fexp = 2,1
$ vbase,vblush,vexp = 6,0,5
vincent "Ти такий слабкий..."
n "Він швидко вдарив мене головою об стіну, відпустивши, через що я впав на холодний асфальт. Це було дуже боляче" with hpunch
$ health -=5
vincent "Ти не мав сюди приходити, неслухняна омежка"
n "Він сидів біля мене навшпиньки, тихо говорячи мені на вухо"
n "Мій зір був нечітким, поки гаряча кров стікала з мого носа. Я відчув залізний присмак крові на своїх губах"
vincent "Ти так гарно підходиш для полювання..."
vincent "Все, що мені треба було - це лише спіймати тебе"
show farz:
    subpixel True
    xpos 0
show vincent:
    subpixel True
    xpos 500
farz "Вінсент, що тут відбувається?"
vincent "Та нічого такого, просто говорю з твоїм новим другом тут"
n "Вінсент погладив мене по голові, посміхаючись Фарцу"
menu:
    "-Попросити допомоги-":
        $ farz_love +=10
        p "Д-допоможи.. б-будь ласка.."
        n "Я вимовив з неабиякими зусиллями"
        $ fbase,fexp = 2,5
        farz "Ти виглядаєш як гімно"
        vincent "Та, мабуть я трохи перестарався, коли вдарив його"
        n "Схоже, Фарц не був зацікавлений у тому, щоб допомагати мені"
    "-Промовчати-":
        $ farz_love +=5
        n "Я не знав, що сказати цим двом, повністю спантеличений"
        n "Я боявся наслідків своїх слів"
        farz "А воно тихе"
        vincent "От і добре. Менше проблем. Так і має бути"
    "-Закричати-":
        $ temper +=10
        $ farz_love -=10
        p "ТА ЙДІТЬ ВИ ОБИДВА НАХУЙ, ПОТВОРИ ОБІСРАТІ, ТА ШОБ ВАС В-..."
        n "Вінсент дуже сильно вдарив мене у грудну клітку. Відчуття були такими, ніби він зламав мені декілька ребер"
        vincent "Думаєш, зараз все погано?"
        vincent "З такою поведінкою буде лише гірше"
        $ fbase,fexp = 2,5

n "Вінсент притиснув своїм черевиком до моєї скроні"
vincent "Добраніч"
$ vincent_love = farz_love
n "Він наступив на мою голову, від чого в моїх очах все почорніло"
$ health -=5
scene black
with fade
jump vincent_day1_start
...
n "Коли я прокинувся наступного дня, я відчув масивну важку руку, що обіймала мене ззаду"
n "Моє обличчя було притиснуте до його грудної клітки, як раптом він мило погладив моє волосся, почувши, що я прокинувся"
show vincent
$ vbase,vblush,vexp = 5,0,9
n "Він оглянув моє голе тіло ще раз та облизався, всміхаючись"
p "Я.. краще піду"
n "Він кивнув, відпустивши мене. Я зміг без проблем встати з ліжка"
vincent "Слухай, ти ж не хочеш, щоб тебе хтось вполював, поки ти тут ходиш?"
n "Вінсент дуже сильно вдарив мене по дупі, щойно я піднявся з ліжка"
p "Агов! Досить!"
n "Я відчув, як дуже сильно почервонів, поки одягався"
n "Я побачив свої роздерті джинси, що лежали на підлозі"
n "Вінсент встав і кинув мені пару спортивних штанів"
vincent "Тримай"
vincent "Потім повернеш, коли я тобі куплю нові"
$ vbase,vblush,vexp = 5,0,6
n "Я почервонів ще сильніше, мені було дуже соромно"
vincent "Ти все ще червонієш біля мене, малий?"
$ vbase,vblush,vexp = 5,0,8
vincent "Я бачив тебе голяка, я кінчав в тебе, чого ти соромишся?"
p "Ну.. просто не думав, що ти будеш радий бачити мене знову"
vincent "Чого? Ти мені подобаєшся"
n "Я кинув свою футболку на його обличчя, щоб він відстав, проте він тільки посміхнувся та понюхав її"
$ vbase,vblush,vexp = 5,0,11
vincent "Ох.. залиш її мені"
vincent "Ти навіть не уявляєш, як мені подобається те, як ти пахнеш"
p "Добре... Але тоді разом з джинсами ти купиш мені і нову футболку"
$ vbase,vblush,vexp = 5,0,8
vincent "Домовились"
n "Вінсент кинув у мене одну зі своїх футболок у відповідь"
n "Якась стара футболка з емблемою якогось рок-гурту"
vincent "В тебе таке миле обличчя"
n "Вінсент підійшов до мене ближче"
vincent "Що ж, тоді гарного дня тобі"
n "Вінсент обійняв мене ще раз, після чого ми попрощались"
p "І тобі гарного дня!"
n "Я вже підійшов до дверей, як раптом почув гучний крик від Вінсента"
$ vbase,vblush,vexp = 5,0,7
vincent "ЧЕКАЙ!"
play music "vincent/skeletons_in_closet.mp3"
n "У мене не було часу обдумати цю фразу, тож я відчинив двері. Це виявилась його шафа, звідки випало щось бридке, що пахло гниллю"
scene CG_vincent_skull with dissolve
$ sanity -=10
n "Воно було схоже на чийсь людський череп..."
vincent "От блять"
p "Щ-що це..?"
n "Я вимовив тремтливим голосом"
vincent "Це.. не ті двері. Вихід з іншого боку"
scene vincent_bedroom_day with dissolve
show vincent
$ vbase,vblush,vexp = 5,0,5
n "Вінсент тихо загарчав і кинувся з місця"
n "Минула лише мить, перш ніж він притиснув мене до стіни"
n "Я відчував, як моя голова вдаряється об цеглу, а тепла кров почала стікати моїм обличчям"
$ health -=10
n "Дзвін у вухах збивав мене, а голова боліла від болю"
n "Все в моїх очах почорніло, як Вінсент нахилився наді мною"
scene black with fade
vincent "...Бляха... {size=12}Ти мені справді подобався..{/size}"
jump vincent_day1_start

label vincent_day1_drunk:
play music "vincent/vincent_morningafter.mp3"
scene vincent_bedroom_day with fade
n "Я застогнав від болю, перевернувшись"
n "Я відчув, як мій шлунок неймовірно болів. Мені терміново треба було в туалет"
n "Я розплющив свої очі та відчув, як сильно моя голова боліла від похмілля"
p "Агхх..."
n "Я притулив долоню до своєї голови, відчуваючи, як мої руки тремтять"
n "Скільки я вчора випив?"
show vincent
$ vbase,vblush,vexp = 5,0,6
vincent "Що, перепив, хлопче?"
n "Вінсент зловтішався наді мною, сміючись"
n "Але він був правий, мені справді не варто було пити настільки багато алкоголю"
n "Я хотів відповісти йому, проте швидко відчув, як блювота заповнює моє горло"
n "Вінсент посміявся, споглядаючи, як я швидко біжу в бік туалету"
n "Я швидко схопив дверну ручку, відчинивши двері"
$ vbase,vblush,vexp = 5,0,7
vincent "ЗАЧЕКАЙ-"
play music "vincent/skeletons_in_closet.mp3"
n "Я чув його голос позаду, проте не міг зосередитися на ньому"
$ sanity -=10
n "Жахливий гнилий запах вдарив мені в ніс, коли я став на коліна перед унітазом та почав ригати"
n "Коли шлунок вже спорожнів, в мене з'явилась можливість оглянути все навколо мене: біля туалету лежав чийсь череп"
scene CG_vincent_skull with dissolve
n "Я був у ступорі, проте від цього жахливого запаху нова хвиля нудоти захопила мене"
n "Кашляючи та намагаючись набрати якомога більше повітря, я знову проригався в унітаз"
n "Я відчував себе слабким і виснаженим, але намагався відповзти від цього жаху подалі"
vincent "Що ти робиш? Куди ти повзеш?"
n "Почувши цей агресивний роздратований голос, я згадав, в чиєму я домі"
scene vincent_bedroom_day with dissolve
show vincent
$ vbase,vblush,vexp = 5,0,5
n "Я підняв свою голову, оглядаючи голе фактурне тіло Вінсента"
p "Я-.."
vincent "Помовч"
n "Він виглядав так, ніби був не в настрої для будь-чого, що б я не сказав. Я побачив, як він наступив на мою голову"
scene black with fade
n "Тиск на мене був занадто сильним, тож я втратив свідомість, все ще відчуваючи цей жахливий запах"
jump vincent_day1_start
...
vincent "Прокидайся"
n "Я відчув, як Вінсент легко вдарив мене по щоках, дивлячись на моє обличчя" with hpunch
n "Я аж закашлявся, в паніці оглядаючись навколо"
scene falloutshelter with dissolve
n "Кімната навколо виглядала як бункер на випадок ядерної війни"
p "Щ-що відбувається?!"
$ vbase,vblush,vexp = 7,0,5
show vincent
n "Вінсент підкидав ніж, ловлячи його тією ж рукою"
n "Він дивився на те, як ніж рухається, ніби це допомагало йому зосередитися та краще обдумати, що сказати"
n "Раптом він схопив ніж однією рукою та кинув прямо в мене"
$ vbase,vblush,vexp = 1,0,5
n "Я рефлекторно намагався відсторонитись від нього, проте відчув, що мої руки були зв'язані за моєю спиною"
n "Я був прикутий наручниками до батареї ззаду"
n "Ніж пролетів повз моє обличчя, порізавши мою щоку, після чого вдарився об стіну та впав додолу"
if vincent_dayzero_sex == True:
    vincent "Слухай, хлопче"
    vincent "Ти бачив забагато"
    vincent "Я не можу тепер просто дозволити тобі піти звідси"
    n "Він оглянув мене, презирливо посміхнувшись"
$ vbase,vblush,vexp = 7,0,5
n "Вінсент підійшов до мене, взявши ніж в руку"
n "Він наблизився до мене, притиснувши гостре лезо до моєї шиї"
vincent "Слухай.. в мене є деякі проблеми з контролем гніву"
show screen vincent_rage_bar
with dissolve
vincent "Невирішений внутрішній конфлікт і бла-бла-бла, у кожного є свої психологічні травми, еге ж?"
n "Він втромив ножа неглибоко в моє горло. Гаряча кров почала стікати по ножу та по моєму горлу"
n "Я відчув потужний викид адреналіну, а моє серце пришвидшилося в рази"
n "Вінсент пронизливим поглядом вдивлявся в те, з яким нажаханим поглядом я спостерігаю за ним"
...
n "Я не знаю коду" # "I don't know the code."
scene falloutshelter_dark
jump vincent_backtosleep_nightone
...
scene falloutshelter_dark:
    xalign 0.0
with dissolve
n "АХУЄТЬ. ВОНО ВІДЧИНИЛОСЯ!" # "IT OPENED."
n "Я радісно вскрикнув і відчинив шафку" # "I let out a happy sound and I opened the locker."
n "Може, я знайду, чим убити цього садистського вилупка" # "Maybe I could find something to kill that sadistic prick with."
vincent "Гей, малий~" # "Hey Kiddo."
n "Мої очі широко розплющились, коли я почув голос позаду" # "My eyes shot open hearing a voice behind me."
n "Я повільно повернув голову й одразу наткнувся на його холодний погляд та зловіщу усмішку" # "I slowly turned my head and was immediately met with an icy cold glare."
show vincent
play music "vincent/vincent_angry.mp3"
$ vbase,vblush,vexp = 1,0,13
n "Я підняв руки й ступив крок назад" # "I put up my hands and took a step back."
p "Я... я можу пояснити" # "I... I can explain."
$ temper +=50
vincent "Можеш пояснити!?" # "You can explain!?"
$ temper +=50
vincent "НУ ТО Я, БЛЯТЬ, ІЗ ЗАДОВОЛЕННЯМ ПОСЛУХАЮ!" # "WELL, I WOULD FUCKING LOVE TO HEAR IT!"
n "Він мав розлючений вигляд, поки я втискався спиною в шафку" # "He looked angry as I pressed my back into the weapon locker."
$ vbase,vblush,vexp = 7,0,13
n "Він не став чекати відповіді й кинувся через кімнату з ножем у руці" # "He didn't wait for me to respond as he charged across the room with a knife in his hand."
$ health -=10
n "Він встромив його мені в руку й кинув мене на землю" # "He plunged it into my arm and threw me to the ground."
n "Я пронизливо заверещав, вдарившись дупою об підлогу" # "I let out a loud shriek as I hit the floor."
n "Я стиснув ніж всередині моєї руки й глянув угору на нього" # "I gripped the knife in my arm and looked up at him."
vincent "Хочеш побачити мій ствол, га?" # "You wanna see a gun huh?"
show CG_Vincent_Aimed_shotgun with dissolve
n "Я почув, як він знімає рушницю зі стійки, поки я повертався" # "I could hear him taking a gun off the rack as I turned my body."
n "Він поставив ногу на мій живіт і навалився всією вагою" # "He put his foot on my stomach and pressed all his weight into me."
n "Вінсент якусь мить витріщався на мене, поки я відчував, як його чобіт трощить мені грудину" # "Vincent stared at me for am moment as I could feel his boot cracking my sternum."
vincent "Ось тобі ствол, вишкребку" # "Here's a gun for you, little prick."
n "Прогарчав Вінсент крізь зуби" # "Vincent growled through his teeth."
n "Я забелькотів і спробував відповзти" # "I stammered and tried to back away."
n "Він скинув рушницю з плеча" # "He slung his gun off his shoulder."
n "Він звів курок з одним гучним клацанням, і я заплющив очі" # "He cocked it with one loud click and I closed my eyes."
$ health -=100
n "Усе, що я почув, - це як набій вилітає з набійника" # "All I heard was the shell leave the chamber."
hide screen health_bar
hide screen sanity_bar
hide screen vincent_rage_bar
...
screen vincent_day1_shot:
    ...
    text "\n\n\n\n{=endslate_subtitle}Вінсент розніс тебе пострілом.{/=endslate_subtitle}" outlines [(2, "000000", 0, 0)] at truecenter # "Vincent blew you away."
...
label vincent_backtosleep_nightone:
    if vincent_key_day1 == True:
        n "Краще більше нічого не чіпати" # "I better not touch anything else."
        n "Я повернувся до батареї й глянув на наручник" # "I walked back to the radiator and looked down at the cuff."
        n "Ключ!" # "The key."
        n "Я відімкнув наручник і знову замкнув його на зап'ястку" # "I unlocked the cuff and locked it around my wrist."
        n "Я був радий, що не довелося силою його заклацувати назад" # "I was glad I didn't have to force it back in."
        n "Я засунув ключ під батарею у межах досяжності і відкинувся назад" # "I slipped the key under the radiator within my reach and leaned back."
        n "Я просто хотів, щоб усе це скінчилося" # "I just wanted this to be over."
        n "Я заплющив очі й знову заснув" # "I closed my eyes and went back to sleep."
        jump vincent_day2_morning
    else:
        n "Краще мені нічого не чіпати..." # "I better not touch anything..."
        n "Він, певно, дуже розлютиться" # "He'd probably get really angry."
        n "Я повернувся до свого наручника й глянув на нього" # "I walked back over to my handcuff and looked down at it."
        n "Як же мені засунути руку назад у наручник?" # "How was I going to get back into the cuff?"
        n "Я нахилився й покрутив його" # "I leaned down and played with it."
        n "Було трохи крові, може, цього вистачить, щоб просунути руку назад у замкнуте кільце" # "It was a little blood, maybe that would be enough to slip my hand back into the closed ring."
        n "Я покрутив кільце й проштовхнув руку в наручник" # "I played with the ring and pushed my hand into the handcuff."
        n "Я тихо заскиглив, відчувши, як мої кістки протискаються повз метал. Мої сльози стікали по обличчю" # "I let out a soft whimper as I felt my bones slipping past the metal."
        $ health -=5
        n "Я зітхнув і знову сів" # "I sighed and sat back down."
        n "Я просто хотів, щоб усе це скінчилося" # "I just wanted this to be over."
        n "Я заплющив очі й знову заснув" # "I closed my eyes and fell back asleep."
        jump vincent_day2_morning
...
scene falloutshelter_dark:
    xalign 0.0
with dissolve
n "Замок гучно клацнув" # "The locker wailed loudly."
n "Звук сигналізації відлунював від стін, і я затиснув вуха руками" # "The sound of the alarm bounced off the walls and I clapped my hands over my ears."
n "Було так гучно, що Вінсент аж ніяк не міг цього не почути" # "It was so loud there was no way that Vincent hadn't heard it."
n "Так само швидко, як почалося, воно й припинилося" # "As quickly as it started it stopped."
n "Я кліпнув, підвівши погляд, може, його немає?" # "I blinked as I looked up, maybe he was out?"
n "Я нічого не почув, коли прибрав руки від вух" # "I didn't hear anything as I took my hands off my ears."
n "Умить я відчув руку на потилиці, і моє обличчя врізалося у стіну" # "In an instant I could feel a hand on the back of my head as my face collided with the storage locker."
n "Кров ринула з носа, а обличчям прострілив різкий біль" # "Blood poured out of my nose as a sheering pain shot up my face."
n "Я заточився, обертаючись і дивлячись угору на Вінсента" # "I stumbled as I turned around looking up at Vincent."
show vincent
$ vbase,vblush,vexp = 1,0,2
n "Він явно був не в гуморі слухати мої виправдання" # "He didn't look like he was in the mood for an excuse."
p "Н-не треба" # "D-don't."
vincent "Не треба чого? Тобі так кортить глянути, що там усередині?" # "Don't what? You wanna see what's in there so bad?"
n "Вінсент відкинув мене ногою вбік і швидко ввів код" # "Vincent kicked me out of the way and quickly keyed in the code."
vincent "О, дивись!" # "Oh look!"
n "Він витягнув великий ніж і підступив ближче" # "He pulled out a large knife and stepped closer."
scene falloutshelter_dark:
    subpixel True
    xalign 0.0
    easeout 0.9 xalign 0.95
hide vincent
n "Я впав на ноги й спробував підповзти" # "I scrambled to my feet and tried to run."
n "Я скривився, відчувши біль у ступнях" # "I cringed feeling the pain in my feet."
n "Півівшись трохи, я побіг від нього" # "I ran away from him."
n "Це майже скидалося на те, що він давав мені фору" # "It was almost like he was giving me a head start."
n "Я затиснув рота рукою, ледь не плачучи, і вхопився за штурвал на сталевих дверях — моєму єдиному виході...." # "I put my hand over my mouth wanting to cry as I grabbed the wheel on the steel door that was my only exit out...."
n "Але я не міг провернути його достатньо швидко" # "But, I couldn't spin it fast enough."
n "Він був надто важкий" # "It was too heavy."
n "Моє дихання пришвидшилося, коли він схопив мене" # "My breathing sped up as he grabbed me."
n "У мене серце обірвалося, коли я відчув важку руку на плечі" # "My heart sank as I felt a heavy hand on my shoulder."
n "Він розвернув мене й змусив глянути на нього" # "He spun me around and forced me to look at him."
vincent "ПОПАВСЯ, ОМЕЖКА~" # "GOTCHA."
show vincent
$ vbase,vblush,vexp = 1,0,5
n "Вінсент увігнав ніж мені між ноги, у пах" # "Vincent jammed the knife between my legs and into my crotch."
$ health -=10
vincent "Обожнюю гратися в квача! Особливо, коли я ловлю" # "I love playing catch!"
n "Я відчував, як лезо ножа впивається в мене, і голосно скрикнув" # "I could feel the knife blade digging into me and I let out a loud cry."
$ health -=10
vincent "Дивись, ти теж збуджений" # "Look you're excited too."
n "Він лизнув мою шию й самовдоволено посміхнувся" # "He licked my neck and smirked."
$ health -=10
vincent "Ти вже кінчив?" # "Did you cum?"
$ health -=10
$ vbase,vblush,vexp = 1,0,4
vincent "Такий весь мокрий..." # "You're all wet."
$ health -=10
n "Мені хотілося просто осісти додолу" # "I wanted to sink to my feet."
$ health -=10
n "Я просто хотів утекти" # "I just wanted to run away."
n "Але лезо в мені нагадувало, що я нікуди не подінуся" # "But, the blade in me reminded me that I wasn't going anywhere."
p "С-стій..." # "St-stop..."
n "Кволо вичавив я" # "I choked out weakly."
vincent "Ні, гадаю, не зупинюся" # "No, I don't think I will."
n "Вінсент розпоров ножем угору крізь мій таз" # "Vincent ripped the knife up through my pelvis."
show CG_Vincent_gutsonthefloor with dissolve
$ health -=100
n "Я відчував, як моє тіло судомить, поки він притискав мене назад до підлоги" # "I could feel my body convulsing as I watched him push me back into the floor."
n "Я нічого не відчував, дивлячись, як він облизує свої губи" # "I couldn't feel anything as I watched him lick his lips."
hide screen health_bar
hide screen sanity_bar
hide screen vincent_rage_bar
play music "vincent/vincent_death.mp3"
...
screen vincent_weaponslocker_day1_fail:
    text "{=endslate_title}Ти помер{/=endslate_title}\n\n\n" outlines [(2, "000000", 0, 0)] at truecenter # "You Died"
    text "\n\n\n\n{=endslate_subtitle}Вінсент тебе спіймав.{/=endslate_subtitle}" outlines [(2, "000000", 0, 0)] at truecenter # "Vincent caught you."
...
if health <=0:
    jump vincent_healthdeath_alone
n "Я здався..." # "I gave up..."
if vincent_key_day1 == True:
    n "Краще більше нічого не чіпати" # "I better not touch anything else."
    n "Я повернувся до батареї й глянув на наручник" # "I walked back to the radiator and looked down at the cuff."
    n "Ключ..." # "The key..."
    n "Я відімкнув наручник і знову замкнув його на зап'ястку" # "I unlocked the cuff and locked it around my wrist."
    n "Я був радий, що не довелося силою його заклацувати" # "I was glad I didn't have to force it back in."
    n "Я засунув ключ під батарею у межах досяжності і відкинувся назад" # "I slipped the key under the radiator within my reach and leaned back."
    n "Я просто хотів, щоб усе це скінчилося.." # "I just wanted this to be over.."
    n "Я заплющив очі й знову заснув" # "I closed my eyes and went back to sleep."
    jump vincent_day2_morning
    ...
    n "Було трохи крові, може, цього вистачить, щоб просунути руку назад у замкнуте кільце" # "It was a little blood, maybe that would be enough to slip my hand back into the closed ring."
    n "Я покрутив кільце й проштовхнув руку в наручник" # "I played with the ring and pushed my hand into the handcuff."
    n "Я тихо заскиглив, відчувши, як мої кістки протискаються повз метал" # "I let out a soft whimper as I felt my bones slipping past the metal."
    $ health -=10
    if health <=0:
        jump vincent_healthdeath_alone
    n "Я зітхнув і знову сів" # "I sighed and sat back down."
...
scene black with fade
n "Наступного ранку я прокинувся від того, що відчинилися двері" # "I woke up the next morning to the door opening."
n "Увійшов Вінсент" # "Vincent walked in."
scene falloutshelter with dissolve:
    subpixel True
    xalign 0.95
...
vincent "Доброго раночку, малий! Який прекрасний день сьогодні." # "Morning, kiddo!"
n "Він присів навпочіпки" # "He kneeled down. "
n "Вінсент глянув на мою руку, а я спробував сховати її за спину" # "Vincent looked at my arm and I attempted hide it behind my back."
$ vbase,vblush,vexp = 3,0,2
vincent "ГЕЙ!" # "HEY!"
vincent "Не намагайся її ховати, неслухняна омежка~" # "Don't try to hide it brat!"
vincent "Я вже її бачив" # "I already saw it."
n "Я пискнув, коли він схопив мою руку й висмикнув її з-за спини" # "I squeaked as he grabbed my arm and yanked it out from behind me."
p "Ауф.." # "OW!"
$ vbase,vblush,vexp = 3,0,9
n "Він глянув на рану й вигнув брову" # "He looked at the wound and cocked an eyebrow."
$ vbase,vblush,vexp = 3,0,8
$ temper +=10
vincent "ТИ ЩО, ВИБРАВСЯ!?" # "DID YOU GET OUT !?"
vincent "І це попри те, що я тебе ПОПЕРЕДЖАВ?" # "Even though I WARNED you?"
n "Вінсент запхав палець мені в рану" # "Vincent pushed his finger into my wound."
$ temper +=10
$ vbase,vblush,vexp = 3,0,5
vincent "Я ж міг зайти сюди будь-якої миті, придурку!" # "That's fucking ballsy, I could have came in here at anytime, you dumbass!"
$ vbase,vblush,vexp = 3,0,8
n "Вінсент ніжно потерся об моє обличчя своїм носом" # "Vincent nuzzled my face gently."
vincent "Ти сміливий, мені це подобається~" # "I like that."
vincent "Дай-но я тобе підлатаю трохи" # "Lemme fix that shit for you."
n "Він несильно ляснув мене по обличчю й підвівся" # "He slapped my face and got up."
n "Вінсент зазирнув у свою шафку й витягнув пляшку" # "Vincent looked in his cabinet and pulled out a bottle."
$ vbase,vblush,vexp = 3,0,5
vincent "Дай мені свою руку" # "Give me your arm."
n "Наказав він, і я послухався, швидко простягнувши руку" # "He demanded and I quickly brought my arm out."
n "Вінсент відкоркував пляшку" # "Vincent uncapped the bottle."
n "Він зняв ключ з пояса й відімкнув наручник" # "He took a key off his belt and unlocked the cuff."
n "Я не рухався" # "I kept still."
n "Він був так близько, що міг би за секунду накинутися й скрутити мені шию" # "With him this close he could spring over and snap my neck in one second."
n "Я ковтнув, коли він полив мою руку" # "I gulped as he poured down my arm."
p "АЙ!" # "OW!"
n "Я закричав і притягнув руку назад до себе" # "I screamed and brought the arm back to myself."
vincent "Поверни мені руку, дурнику. Я не закінчив" # "Give me your arm back."
menu:
    "\"Ні!\"": # "No!"
        $ temper +=10
        n "Вінсент незадоволено видихнув та схопив мою руку" # "Vincent shrugged and grabbed my arm."
        vincent "Ти так поводишся, ніби в тебе взагалі є вибір" # "You don't have a choice."
        if temper >=70:
            jump vincent_temper_death
        n "Він полив цим мою руку, а я засичав крізь зуби" # "He poured it down my arm as I hissed through my teeth."
        p "БОЛЯЧЕ!" # "IT HURTS!"
        vincent "Так і має бути" # "I'm not surprised."
        n "Вінсент притулив губи до пляшки й зробив кілька великих ковтків" # "Vincent put his lips to the bottle and chugged a few big gulps."
        $ vbase,vblush,vexp = 3,1,8
        vincent "Це ж 95%-ий спирт" # "It's fuckin Everclear."
    "\"Що це таке!?\"": # "What is that!?"

        $ temper +=10
        n "Вінсент витріщився на мене" # "Vincent stared at me."
        if temper >=70:
            jump vincent_temper_death
        n "Він зробив кілька ковтків з неї" # "He drank a few gulps out of it."
        $ vbase,vblush,vexp = 3,1,8
        vincent "95%-ий етиловий спирт, хіба не видно?" # "Everclear."
...
scene falloutshelter with dissolve
show vincent
n "Я голосно закричав на нього" # "I screamed loudly at him."
if temper >=70:
    jump vincent_temper_death
n "Він знизав плечем" # "He shrugged a shoulder."
vincent "Ну гаразд" # "Well okay."
n "Він знову підняв мене й штовхнув ногою в стіну" with hpunch # "He picked me back up and kicked me into the wall."
$ health -=5
if health <= 0:
    jump vincent_health_death
...
menu:
    "-Відмовитися-": # "-Refuse-"
        hide screen countdown
        n "Я тримав рота стуленим" # "I kept my mouth shut."
        n "Я не збирався просто здатися й робити все, що він захоче" # "I wasn't going to just roll over and do whatever he wants."
        vincent "Ти диви, як стиснув губи" # "Look at your tight lips."
        vincent "Тц-тц" # "Tsktsk."
        n "Вінсент відступив на крок і підняв свій ніж" # "Vincent took a step back and picked up his knife."
        n "Він глянув на лезо, поки я відповзав" # "He looked at the edge as I backed up."
        n "Я став на коліна й заметушився" # "I got on my knees and scrambled around."
        n "Я ніяк не міг знайти опору" # "I couldn't get my footing."
        $ sanity -=20
        $ health -=20
        n "Вінсент смикнув мою голову вгору й притиснув ніж до кутика мого рота" # "Vincent yanked my head up and pushed the knife to the side of my mouth."
        $ vbase,vblush,vexp = 3,1,5
        vincent "Усміхнись, малий" # "Smile, kiddo."
        $ sanity -=20
        $ health -=20
        n "Він різонув ножем крізь мою щоку, і кров швидко наповнила рот" # "He yanked the knife through my cheek, the blood quickly filling my mouth."
        $ sanity -=20
        $ health -=20
        n "Я захлинався й кашляв" # "I sputtered and coughed."
        $ sanity -=20
        $ health -=20
        ...
        vincent "Як шкода!" # "That's too bad!"
        hide screen health_bar
        hide screen sanity_bar
        hide screen vincent_rage_bar
        play music "vincent/vincent_death.mp3"
        ...
        screen vincent_ending_opened_mouth:
            text "{=endslate_title}Ти помер{/=endslate_title}\n\n\n" outlines [(2, "000000", 0, 0)] at truecenter # "You Died"
            text "\n\n\n\n{=endslate_subtitle}Він відкрив тобі рота.{/=endslate_subtitle}" outlines [(2, "000000", 0, 0)] at truecenter # "He opened your mouth."
...
n "Я спробував відсунутися від нього й вхопився за його ноги" # "I tried to back away from him and grabbed his legs."
n "Але відчув, як спина вперлася в стіну" # "But I felt the wall hit my back."
scene falloutshelter with dissolve:
    subpixel True
    xalign 0.95
show vincent
n "Вінсент затиснув мені ніс, поки я намагався викашляти його сечу з рота" # "Vincent pinched my nose shut as I tried to cough his piss out of my mouth."
menu:
    "-Проковтнути-": # "-Swallow-"
        $ sanity -=10
        if sanity <= 0:
            n "В очах помутніло, і я знепритомнів" # "My vision went blurry and I blacked out."
            jump vincent_badend_vore
        n "Я проковтнув його сечу, і він відпустив мій ніс" # "I swallowed his piss and he let my nose go."
        $ vbase,vblush,vexp = 3,1,8
    ...
    "-Пручатися-": # "-Struggle-"
        ...
        $ temper +=10
        vincent "Ти в ній захлинешся" # "You're gonna drown in it."
        n "Вінсент голосно засміявся й вдарив мене ногою в живіт" # "Vincent laughed loudly as he kicked my gut."
        $ health -=5
        if health <= 0:
            jump vincent_health_death
...
$ vincent_love += 10
$ sanity -=20
n "Я обережно лизнув підлогу перед собою" # "I licked the floor in front of me gently."
if sanity <= 0:
    n "В очах помутніло, і я знепритомнів" # "My vision went blurry and I blacked out."
    jump vincent_badend_vore
scene falloutshelter with dissolve
...
n "Здавалося, ніби він мене обнюхує, аж поки не вп'явся зубами мені в плече" # "It felt like he was sniffing me until he pushed his teeth into my shoulder."
n "Я голосно закричав, але крик перейшов у стогін" # "I let out a loud scream, but, it trailed off into a moan."
$ vbase,vblush,vexp = 3,1,9
vincent "Оце те, що я хочу чути" # "That's what I like to hear."
n "Він лизнув моє плече й різко штовхнувся в мене" # "He licked my shoulder and pushed into me hard."
...
scene falloutshelter with dissolve:
    ...
    xalign 0.95
    easeout 0.9 xalign 0.5
n "Вінсент увійшов і глянув на мене згори вниз" # "Vincent walked in and looked down at me."
show vincent with dissolve
...
menu:
    ...
    "-Мовчати-": # "-Keep quiet-"
        ...
        $ sanity +=10
        $ vincent_love -=10
        n "Я тримав рота стуленим, а Вінсент пирхнув" # "I kept my mouth shut and Vincent snorted."
        vincent "Так я і думав" # "That's what I thought."
        n "Він рушив до мене" # "He moved towards me."
        jump vincent_daytwo_part2
...
n "Вінсент видав задоволений звук і штовхнув мене на підлогу" # "Vincent let out a pleasured sound and pushed me on the floor."
n "Він сів мені на ноги" # "He sat down on my legs."
n "Я лежав нерухомо для нього й напружився" # "I laid still for him and tensed up."
n "Моє тіло було задерев'янілим, але я важко дихав, дивлячись на його кулаки, як він хрускав ними" # "My body was stiff but I was breathing hard looking at his knuckles as he cracked them."
n "Він виставив руку прямо перед моїм обличчям, і я глянув на неї" # "He put out his hand right in front of my face and I looked at it."
n "Я притиснув губи до його грубих кісточок і лизнув виступи його кулака" # "I pressed my lips against his rough knuckles and licked the ridges of his fist."
$ vbase,vblush,vexp = 3,1,1
p "Зроби мені боляче, я витримаю" # "Hurt me, I can take it."
$ vbase,vblush,vexp = 3,1,5
n "Вінсент пирхнув і вгатив мені прямо в обличчя" with vpunch # "Vincent scoffed and punched me right in the face."
$ health -= 5
$ temper -= 5
if health <= 0:
    jump vincent_health_death
n "Я відчував, як кров ллється з носа, але здавалося, що він стримується" # "I could feel the blood pouring out of my nose but I felt like he was holding back."
n "Я злизав власну кров, поки його око прикипіло до мого тіла" # "I licked my own blood as his eye locked on to my body."
n "Він відвів руку й вдарив мене в живіт, я відчув, як повітря вибиває з мене" # "He pulled back and punched me in the stomach, I could feel the air pushing escaping me."
$ health -= 5
$ temper -= 5
if health <= 0:
    jump vincent_health_death
n "Я охнув від болю, але мої ноги під ним тремтіли від збудження" # "I let out a gasp of pain, but my legs were shaking with excitement underneath him."
vincent "Тобі це справді подобається, га?" # "You really like this hm?"
n "Я повільно кивнув і глянув на його пах, він щойно трахнув мене, але член усе ще стояв" # "I slowly nodded my head and looked at his crotch, he just had sex with me but he was still hard."
n "Я облизав губи й благально глянув на нього" # "I licked my lips and looked up at him pleading."
p "Дай я цим займуся" # "Let me take care of that."
n "Руки Вінсента метнулися вперед і міцно стиснули моє горло" # "Vincent's hands shot out and wrapped around my throat pushing hard."
n "Голова пішла обертом" # "My head started to swim."
$ health -= 5
$ temper -= 5
if health <= 0:
    jump vincent_health_death
vincent "З чого ти взяв, що впораєшся?" # "What makes you think you can?"
p "Дай спробувати, я хочу твій член" # "Let me try, I want your cock."
n "Я намагався якомога краще видушити слова крізь його великі руки" # "I tried to choke out my words as best as I can past his large hands."
n "Мабуть, я звучав як божевільний" # "I must have sounded crazy."
n "Чому він мав би довірити мені таке?" # "Why should he trust me with that?"
...
n "Він більшав у мене в роті, і я перемістив руки, щоб охопити решту товщини" # "He was getting bigger in my mouth and moved my hands to help the rest of the girth."
n "Він запустив руки мені у волосся й сильно смикнув, насаджуючи мене на член" # "He pushed his hands through my hair and pulled hard forcing me down on his cock."
vincent "Це все, на що ти здатен?" # "Is that all you got?"
vincent "Мені треба більше" # "I need more than that."
...
n "Я почув гучний грюкіт у двері" # "I heard a loud banging on the door."
n "Вінсент відвів увагу від мене й глянув туди, насупившись" # "Vincent pulled his attention away from me and looked over with a frown."
vincent "Що там ще?" # "What is it now?"
n "Він відійшов від мене й відчинив двері, щоб впустити того, хто там був" # "He moved away from me and opened the door to let whoever it was in."
show farz:
    subpixel True
    xalign 0.5
...
n "Це був той хлопець з бару!" # "It was that guy from the bar!"
$ vbase,vblush,vexp = 3,0,2
vincent "Чого тобі треба?" # "What do you want?"
farz "Я хотів поговорити з тобою про нього" # "I wanted to talk to you about them."
n "Око Вінсента перевело погляд з мене на Фарца" # "Vincent's eye moved from me to Farz."
vincent "А що з ним?" # "What about them?"
$ fbase,fexp = 1,6
farz "Дай мені з ним побитися" # "Lemme fight them."
$ vbase,vblush,vexp = 3,0,1
vincent "Якого хуя? Ні" # "What the fuck? No."
$ fbase,fexp = 1,1
...
label vincent_refuseknife:
    if health >=40:
        $ sanity -=10
        if sanity <= 0:
            n "В очах потемніло і я знепритомнів" # "My vision went blurry and I blacked out."
            jump vincent_badend_vore
        p "Ні!" # "No."
        p "Я цього не робитиму!" # "I won't do it!"
        farz "Яке ж воно нудне" # "How boring."
        farz "Похуй, він все одно довго не проживе" # "Nevermind, they don't have much time to live anyways."
        vincent "От бачиш. Тепер валимо звідси" # "See. Now let's get outta here."
        n "Вінсент виштовхнув Фарца з кімнати, навіть не глянувши на мене вдруге" # "Vincent pushed Farz out of the room without a second glance at me."
        ...
        $ vbase,vblush,vexp = 3,0,7
        p "Н-ні!" # "N-no!"
        vincent "Ти що, блять, знущаєшся?" # "You're fucking kidding right?"
        n "Він закотив очі й глянув на Фарца" # "He rolled his eye and looked at Farz."
        $ vbase,vblush,vexp = 3,0,5
        vincent "Давай!" # "Go ahead. "
        vincent "У ньому вже не лишилося сил битися" # "They don't have fight left in them."
        n "Він відступив убік" # "He stepped out of the way."
        $ fbase,fexp = 1,5
        hide vincent with dissolve
        show farz at center with dissolve
        n "Він переступив через мене й притиснув ногою моє коліно" # "He stepped over me and put his foot on my knee pushing down."
        farz "Я хочу тебе вбити" # "I want to kill you."
        farz "Якщо ти просто сидітимеш, то мені буде тільки легше" # "If you're going to just sit there then that'll just make it easier for me."
        p "Ми можемо працювати разом" # "We can work together."
        p "Т-тобі не обов'язково це робити!" # "Yo-You don't have to do this!"
        n "Він голосно пирхнув і встромив у мене ніж" # "He snorted loudly and stabbed me."
        $ health -=20
        n "Я голосно закричав і схопив його за руку, намагаючись відштовхнути" # "I let out a loud scream and put my hands around his, trying to push him off."
        n "Він був набагато сильніший, ніж здавався" # "He was a lot stronger than he looked."
        farz "З якого дива мені тобі допомагати?" # "Why would I want to help you?"
        n "Він провернув ніж в моїй рані і нахилився ближче" # "He twisted the knife and leaned in."
        $ health -=50
        n "Я тихо засичав крізь зуби, відчуваючи пронизливий гострий біль в животі" # "I let out a low hiss between my teeth as the pain shot through my stomach."
        $ fbase,fexp = 1,5
        farz "Мій господар подобається мені більше, ніж ти" # "I like him more than you."
        n "Вінсент спостерігав з посмішкою на обличчі" # "Vincent watched with a grin on his face."
        $ health -=50
        n "Він проштовхнув лезо крізь мій живіт, вивернувши кишки на підлогу" # "He pushed the blade through my stomach spilling my guts all over the floor."
        n "Я недовірливо витріщився на купу нутрощів" # "I stared in disbelief at the pile of viscera."
        n "Я впав на бік і глянув угору на нього" # "I fell on my side and looked up at him."
        n "Він швидко дихав і заправив волосся за вухо" # "He was breathing fast and he tucked his hair behind his ear."
        farz "Ти був легкою здобиччю" # "You were easy."
        show CG_Vincent_Cuddle_Farz with dissolve
        n "Вінсент підійшов ззаду й обійняв Фарца за плечі" # "Vincent came up behind himF and wrapped his arms around Farz's shoulders."
        vincent "Хаха, чорт" # "Haha, shit."
        vincent "А ти все ще той сучий син, якого я пам'ятаю. Моє ж ти чортенятко~" # "You're still a fucking badass."
        n "Я дивився, як він тицяється носом під підборіддя Вінсента, поки в мене в очах не потемніло" # "I watched him nuzzle under Vincent's chin as my vision went black."
        hide screen health_bar
        hide screen sanity_bar
        hide screen vincent_rage_bar
        play music "vincent/vincent_death.mp3"
        ...
        screen vincent_ending_refused_knife:
            text "{=endslate_title}Ти помер{/=endslate_title}\n\n\n" outlines [(2, "000000", 0, 0)] at truecenter # "You Died"
            text "\n\n\n\n{=endslate_subtitle}Вінсент тебе замінив.{/=endslate_subtitle}" outlines [(2, "000000", 0, 0)] at truecenter # "Vincent replaced you."
...
n "Я взяв ніж у Вінсента й глянув на гостре лезо" # "I took the knife from Vincent and looked at the sharp blade."
n "Я глянув на нього" # "I looked at him."
n "Я не був певен, що можу зараз зробити" # "I wasn't sure what I could do right now."
n "Я тримав ніж тремтливими руками" # "I held the knife."
menu:
    "-Напасти на Вінсента-": # "-Attack Vincent-"
        n "Я підвівся й стиснув ніж" # "I got up and gripped the knife."
        n "Я мусив спробувати" # "I had to try."
        jump vincent_attack_him
    "-Захищатися-": # "-Defend yourself-"

        if health <30:
            n "Я підняв ніж і спробував зосередитися на ньому" # "I picked up the knife and tried to focus on it."
            n "Голова трохи паморочилася" # "I felt a bit dizzy."
            p "Гаразд!" # "Fine."
            n "Я кинувся на того хлопця й замахнувся в його бік" # "I charged at the other guy and took a swing in his direction."
            n "Я відчув, як його коліно врізається мені в живіт" with vpunch # "I could feel his knee colliding with my stomach."
            n "Він був сильніший, ніж здавався!" # "He was stronger than he looked!"
            $ health -=10
            n "Я закашлявся, а він засміявся, грубо смикнувши мене за волосся" # "I started to cough and he laughed pulling my hair roughly."
            $ fbase, fexp = 1,5
            farz "Ти навіть встояти не можеш, жалюгідне створіння" # "You can't even stand up."
            n "Він жорстко жбурнув мене на землю, придавивши мене своєю ногою до підлоги" # "He yanked me hard into the groud grinding his heel into my back."
            $ health -=10
            n "Він сильно притупнув і пирхнув" # "He stomped down hard and scoffed."
            farz "Ти таке слабке" # "You're so pathetic."
            n "Він сів мені на спину й без опору вийняв ніж з моєї руки" # "He sat down on my back and took the knife out of my hand without resistance."
            p "Пішов ти..." # "Fuck... you."
            n "Він вдавив мою голову в бетон, і я відчув, як моє обличчя відбилося від підлоги" # "He pushed my head into the cement and I could feel my face bounce off the floor."
            n "Він сів мені на спину й вчепився рукою в моє волосся" # "He sat down on my back and twisted his hand into my hair."
            farz "Вінсент уже награвся з тобою" # "Vincent's had enough fun with you."
            farz "Тепер моя черга" # "It's my turn."
            show CG_Farz_Stab with dissolve
            n "Він провів ножем по моїй спині, глибоко розрізаючи мою шкіру" # "He carved the knife down my back cutting deep."
            n "Я закричав, коли він провів кінчиком ножа по виступах мого хребта" # "I let out a scream as he traced the ridges of my spine with the tip of the knife."
            n "Я пручався, поки він постукував кінчиком ножа по кістках" # "I struggled as he tapped the bones with the tip of his knife."
            n "Він встромив ніж мені в бік і я голосно закричав" # "He pushed the knife into my side and I let out a loud scream."
            $ health -=50
            n "Біль прострілив мою ногу, і я дряпав підлогу, намагаючись відповзти від нього" # "The pain shot down my leg and I scratched to get away from him."
            n "Він засліплював" # "It was blinding."
            p "ПРИПИНИ!" # "STOP!!"
            n "Я міг тільки кричати, поки він провертав ніж" # "I could only scream as he twisted the knife."
            n "Мене від цього нудило" # "It made me feel sick."
            $ health -=50
            n "Усе тьмяніло" # "Everything was going dark."
            vincent "Єбать, Фарц, який же ти збочений" # "Holy shit, Farz."
            hide screen health_bar
            hide screen sanity_bar
            hide screen vincent_rage_bar
            play music "vincent/vincent_death.mp3"
            ...
            screen vincent_ending_farz_killed:
                text "{=endslate_title}Ти помер{/=endslate_title}\n\n\n" outlines [(2, "000000", 0, 0)] at truecenter # "You Died"
                text "\n\n\n\n{=endslate_subtitle}Ти був занадто слабким.{/=endslate_subtitle}" outlines [(2, "000000", 0, 0)] at truecenter # "You were too weak."
            show screen vincent_ending_farz_killed
            with Dissolve(1.0)
            pause
            return
        if vincent_love < 90:
            n "Я почувався добре" # "I felt good."
            n "Я взяв ніж і всміхнувся йому" # "I took the knife and smiled at it."
            n "Гадаю, я міг би це зробити" # "I think I could do it."
            n "Я розвернувся на п'яті до іншого чоловіка в кімнаті й рушив на нього" # "I shifted my heel to the other man in the room and advanced on him."
            n "Зірвавшись з місця, я кинувся на нього й повалив на підлогу" with hpunch # "Leaping from my spot, I charged at him and tackled him to the floor."
            n "Він схопив мене за руку, щоб не дати себе штрикнути, але я мусив спробувати" # "He grabbed my arm to stop me from stabbing him, but I had to try."
            n "Я вдарив його в обличчя, намагаючись ослабити" # "I punched him in the face trying to weaken him."
            n "Не спрацьовувало" # "It wasn't working."
            n "Ми обидва якусь мить боролися, але мені вдалося опустити ніж донизу" # "We both struggled for a moment, but I was able to push the knife downwards."
            n "Він голосно загарчав, намагаючись скинути мене" # "He let out a loud growl, struggling to push me off."
            n "Він спробував ударити мене коліном у живіт, але я притиснув коліном його другу ногу" # "He tried to knee me in the stomach but, I kneeled on his other leg."
            n "Лише" # "Just."
            n "трохи" # "A bit."
            n "більше!" # "More."
            $ fbase, fexp = 1,2
            n "Я відчув, як його сила слабшає, і опустив ніж донизу" # "I felt his strength give out and I pushed the knife down."
            play sound "vincent/gunshot.mp3"
            $ health -=30
            pause (.5)
            n "У вухах пролунав постріл, я відчув, як ніж падає на підлогу, а моя рука кровоточить" # "A shot ran out in my ears as I felt the knife hit the floor and my hand was bleeding."
            n "Мої очі розширилися, коли я притягнув руку до себе, велика діра в долоні кровоточила на всі боки" # "My eyes widened as I pulled my hand close, the gaping hole in my hand was bleeding everywhere."
            vincent "Я не збирався втручатися" # "I wasn't going to step in."
            $ health -=10
            n "Він опустив пістолет і відкинув мене ногою вбік" # "He lowered his handgun and kicked me aside."
            n "Вінсент підняв іншого хлопця на ноги, той кинувся на мене, але Вінсент відштовхнув його назад" # "Vincent pulled the other guy to his feet and he lunged at me but Vincent forced him back."
            vincent "Обережніше, омежко" # "Watch it, little bird."
            n "Він люто вчепився у руку Вінсента, але з незадоволеним обличчям зробив, як йому сказали" # "He gripped Vincent's arm angrily but did what he was told."
            show CG_VINCENT_gunup_Farzbehind with dissolve
            vincent "Дивлячись, як ти мало не взяв над ним гору-" # "Watching you almost get the upper hand on him-"
            vincent "Виявляється, я ще не готовий до нового члена зграї" # "Turns out I'm not ready for a new packmate."
            n "Вінсент на мить глянув на меншого хлопця" # "Vincent looked down at the smaller man for a moment."
            vincent "Тож ти маєш зникнути" # "So, you gotta go."
            n "Вінсент підняв пістолет, яким прострелив мені руку, і націлив мені в голову" # "Vincent held up the handgun he used to shoot my hand and aimed it at my head."
            play sound "vincent/gunshot.mp3"
            $ health -=50
            pause (.5)
            hide screen health_bar
            ...
            screen vincent_ending_stepped_in:
                text "{=endslate_title}Ти помер{/=endslate_title}\n\n\n" outlines [(2, "000000", 0, 0)] at truecenter # "You Died"
                text "\n\n\n\n{=endslate_subtitle}Вінсент втрутився.{/=endslate_subtitle}" outlines [(2, "000000", 0, 0)] at truecenter # "Vincent stepped in."
        ...
        if vincent_love >=90 and health >=30:
            $ vincent_love +=10
            $ fexp = 2
            farz "Я так легко не здамся" # "I won't go down so easy."
            n "Він стрибнув на мене, а Вінсент відступив на крок, піднявши руки" # "He lept at me and Vincent took a step back, his hands up."
            n "Вінсент явно вирішив дати нам просто з'ясувати все в бійці" # "Vincent was determined to let us just duke it out."
            n "Він відвів руку назад і вдарив мене в обличчя" # "He reeled back his arm and punched me in the face."
            farz "Вінсент мій!" # "Vincent's mine."
            n "Він був набагато сильніший, ніж здавався" # "He was a lot stronger than he looked."
            n "Я міцніше стиснув ніж, коли він схопив мене за зап'ясток" # "I gripped the knife harder as he grabbed my wrist."
            n "Він уже навіть не говорив, лише видавав гучні злі звуки" # "He wasn't even talking anymore just making loud angry sounds."
            n "Я стиснув ніж і різонув його по руці" # "I gripped the knife and cut his hand."
            n "Він відхилився назад і врізався лобом мені в ніс" with hpunch # "He leaned back and smashed his forehead into my nose."
            $ health -=5
            n "Я відчув, як біль розквітає посеред мого обличчя" # "I could feel the blossoming from the middle of my face."
            n "Він був такий невблаганний" # "He was unrelenting."
            n "Я стиснув ніж і штрикнув його в бік" # "I gripped my knife and stabbed him in the side."
            n "Він видав злий звук і стиснув руками моє горло" # "He let out an angry sound as he pushed his hands around my neck."
            n "Я задихався й хрипів, провертаючи ніж всередині Фарца" # "I choked and sputtered as I tried to pull the knife through."
            $ vexp = 7
            hide farz
            play music "vincent/vincent_Loss.mp3"
            n "Я впустив лезо, коли чоловік упав на мене зверху" # "I dropped the blade as the man fell on top of me."
            show vincent at center
            vincent "Йобаний шашлик, цей хлоп ніяк не хотів здихатися, га?" # "Jesus fucking christ, that guy wouldn't go down would he?"
            n "Він схопив мене за руку й знову прикував до батареї" # "He grabbed my arm and locked me back on the radiator."
            n "Вінсент глянув на тіло свого колишнього хлопця та підняв його тіло" # "Vincent picked him up and looked down at the body."
            $ vexp = 2
            vincent "Чорт..." # "Shit."
            n "Він навіть не озирнувся на мене, виходячи з кімнати" # "He didn't even glance back at me as he left the room."
            n "Двері зачинилися з гучним глухим грюкотом" # "The door shut with a loud hollow bang."
            n "Я заплющив очі, сподіваючись прогнати образ того, що я щойно зробив" # "I closed my eyes hoping to shut out the image of what I just did."
            scene black with fade
            jump vincent_day2_night

label vincent_attack_him:
    if vincent_love >=70:
        n "Я кинувся на нього, але він ухилився від мого леза" # "I charged at him and he dodged my blade."
        vincent "ОТ ЧОРТ!" # "WOAH SHIT."
        n "Він облизав губи й швидко опинився за моєю спиною" # "He licked his lips and moved quickly behind me."
        n "Я був недостатньо швидким...." # "I wasn't fast enough...."
        n "Я вже був поранений" # "I was already hurt."
        n "Він схопив мою руку й заламав її за спину, сильно натиснувши" # "He grabbed my arm and twisted it behind my back, pushing down hard."
        vincent "Знаєш, ти вже почав мені трохи подобатися" # "Ya know, I was was starting to like you a bit."
        vincent "Але якщо ти збираєшся все ускладнювати" # "But if you're going to make life hard."
        vincent "Фарц мав рацію" # "Farz was right."
        vincent "Тебе не варто тримати біля себе" # "You're not worth keeping around."
        n "Він схопив мене за потилицю й притиснув до землі" # "He grabbed the back of my head and pushed me down into the ground."
        vincent "Вибач, цуценятко" # "Sorry, pup."
        n "Він схопив мене за волосся й почав гатити моєю головою об бетонну підлогу" # "He grabbed my hair and started to smash my head into the concrete floor."
        n "Біль розтікався обличчям, поки він знову й знову бив мене лицем об землю" # "The pain radiated through my face as he repeatedly bashed my face into the ground."
        n "Я відчував, як усі мої передні зуби ламаються всередину" # "I could feel all my front teeth breaking inwards."
        $ health -=50
        n "Кров заполонила всі мої відчуття, коли він кинув мене на землю" # "Blood filled up my senses as he dropped me on the ground."
        $ health -=50
        vincent "Шкода. Ти мені справді подобався" # "Pity."
        hide screen health_bar
        hide screen sanity_bar
        hide screen vincent_rage_bar
        play music "vincent/vincent_death.mp3"
        ...
        screen vincent_ending_worthless:
            text "{=endslate_title}Ти помер{/=endslate_title}\n\n\n" outlines [(2, "000000", 0, 0)] at truecenter # "You Died"
            text "\n\n\n\n{=endslate_subtitle}Тебе не варто було лишати.{/=endslate_subtitle}" outlines [(2, "000000", 0, 0)] at truecenter # "You weren't worth keeping."
        ...
        n "Я підвівся й кинувся на нього з правого боку" # "I got up and charged at him from the right side."
        if persistent.cain_call == True:
            show screen cain_feather
        n "На те око він не бачив, тож я сподівався скористатися цим на свою користь" # "He was blind in that eye, I hoped I could use it to my advantage."
        n "Але.... Це тривало недовго, бо я відчув удар ногою по нозі" with vpunch # "But.... It was short lived as I felt myself getting kicked in the leg."
        n "Я повернув голову й глянув на Фарца" # "I turned my head and looked at Farz."
        hide screen cain_feather
        $ fbase,fexp = 1,5
        n "Ця самовдоволена вишкірена посмішка..." # "That shit eating grin."
        n "Вінсент поставив чобіт мені на груди й самовдоволено посміхнувся" # "Vincent put his boot on my chest and smirked."
        vincent "Гарна спроба" # "Nice try."
        n "Він витягнув пістолет із-за спини й націлив мені в голову" # "He pulled out a handgun from the back of his pants and aimed it at my head."
        n "Він на мить глянув на іншого" # "He looked at the other person for a moment."
        vincent "Дякую, омежко" # "Thanks baby."
        play sound "vincent/gunshot.mp3"
        pause (.5)
        n "Він вишкірився й натиснув на спусковий гачок" # "He grinned and pulled the trigger."
        $ health -=100
        hide screen health_bar
        hide screen sanity_bar
        hide screen vincent_rage_bar
...
n "Вінсент відчинив двері й глянув на невисокого чорноволосого хлопа" # "Vincent opened the door and looked at the little brunette."
$ fbase,fexp = 3,1
show farz:
    xalign .9
show vincent:
...
vincent "Наглянь за ним, Фарце" # "Watch over them, Farz."
...
n "Вінсент нахилився, легенько понюхав його й поцілував у носа перш ніж піти" # "Vincent leaned down and gave him a small sniff and a kiss behind the ear before he walked away."
hide vincent
show farz at center
...
menu:
    ...
    "-Мовчати-": # "-Say nothing-"
        ...
        farz "Тобі ДУЖЕ пощастило, що він тебе не вбив" # "You're lucky he didn't kill you."
        jump farz_daytwo_nothing

label farz_daytwo_nothing:
menu:
    "\"Через це твоє око... таке?\"": # "Is that what happened to your eye?"
        $ farz_love +=10
    ...
    "\"Ти божевільний, якщо вважаєш, що бути закатованим — це щастя!\"": # "You're crazy if you think getting tortured is lucky!"
        ...
        n "Він грався з ножем, обмацуючи лезу пальцями та нігтями" # "He scratched his knife across the table top then picked his nails."
...
label farz_daytwo_talk:
    menu:
        "\"Гарні кафи на вухах.\"": # "Those are cute ear cuffs."
            ...
            farz "Хоча не те щоб ти хоч щось про це тямив" # "Not that you'd know shit about that."
            if farz_love <=40:
                jump farz_daytwo_teach
            else:
                jump farz_daytwo_punishment
        "\"Чому ти взагалі щось для нього робиш?\"": # "Why do you do anything for him?"
            ...
            $ farz_love -=10
            p "Він тільки те й робить, що б'є тебе" # "All he does is beat on you."
...
p "Будь ласка, я просто хочу бути корисним" # "Please, I just want to be useful to you."
$ fbase,fexp = 3,2
...
menu:
    ...
    "-Не усміхатися-": # "-Don't smile-"
        ...
        n "Я був безсилий, поки прикований до батареї" # "He was stronger than me."
        n "Біль пронизував моє обличчя, коли він вирізав шкіру навколо ока" # "The pain shot through my face as he carved the skin around my eye."
        ...
        farz "Вінсенту ти, може, і справді сподобався б" # "Vincent might actually like you."
        hide screen health_bar
        hide screen sanity_bar
        hide screen vincent_rage_bar
...
menu:
    "-Опустити руку-": # "-Put your hand down-"
        ...
        n "Вона кровоточила й і сіпалася від болю" # "It was bleeding and throbbing in pain."
...
if vincent_key_day1 == True:
    ...
    n "Тепер я міг озирнутися" # "Now I could look around."
...
$ sanity -=10
$ health +=10
n "Я був надто виснажений, щоб оглядати все далі" # "I was too tried to keep looking around."
...
vincent "ОХ СТРИВАЙ-НО" # "WOAH WAIT A SECOND."
...
$ vbase,vblush,vexp = 3,0,1
n "Член стояв лише наполовину" # "He was only half erect."
...
n "Він почав важко дихати і розслабився" # "He was starting to pant and look happy."
$ vbase,vblush,vexp = 3,1,16
...
vincent "Іди спати, омежко" # "Go to sleep, pup."
...
show vincent
n "Він вгатив прикладом дробовика мені в ніс і голосно загарчав" # "He bashed the butt of the shotgun into my nose and snarled loudly."
...
$ health -=10
n "Я знову закричав, коли Вінсент запхав ніс чобота мені в рот" # "I let out another scream as Vincent put the tip of his boot in my mouth."
$ health -=10
vincent "До того ж він для того, щоб катувати тупих виродків, як ти" # "Plus, it's for torturing stupid fucks like you."
vincent "Тренування на мішенях" # "Target practice."
...
if vincent_code_day1 == True:
    hide screen vincent_picture_day2
n "Що я зможу знайти тут..?" # "What can I find..?"
...
n "Думки закружляли, і мене почало нудити" # "My mind started to race and I felt sick."
$ sanity -=10
jump vincent_night2_tableexplore
...
vincent "Втратив пам'ять в автокатастрофі" # "Lost it all in a car accident."
...
vincent "Я знав, що ти його поцупив, шмаркач" # "I know you took it brat."
...
p "Сміливий або тупий" # "Brave or stupid."
$ vbase,vblush,vexp = 3,0,6
vincent "Одне з двох" # "It's one of those two things."
$ vbase,vblush,vexp = 3,0,2
...
vincent "Це не собачий корм не переживай" # "That's not dog food."
...
n "Я не міг зосередитися на хлопці переді мною" # "I couldn't keep focus on the man in front of me."
...
vincent "«Відвали, Вінсе, це ти сам мене сюди, блять, запхав...»" # "'Fuck off Vince, you're the one who fuckin put me here.'"
...
vincent "Смійся-смійся, омежко" # "Laugh it up, pup."
...
p "Зрозумів, тепер вірю" # "Point taken."
...
menu:
    "\"Навіщо тягнути когось сюди?\"": # "Why take someone down here?"
        ...
        vincent "Я б і тих людей повбивав теж" # "I'd kill those people too."
    ...
    "\"Ти не можеш мене відпустити?\"": # "Can't you let me go?"
        ...
        vincent "Знаєш, скільки черепів я провалив оцим малюком?" # "You know how many people's skulls I've caved in with this baby?"
        ...
        n "Я відчув, як вона одним різким рухом врізається мені в ніс, ламаючи кістку" with vpunch # "I could feel the wood smash into my nose with one swift movement, breaking the bone."
        $ health -=10
        n "Я пронизливо закричав, коли відчуваючи лише смак крові в горлі" # "I let out a high pitched scream as the blood filled my senses."
        ...
        n "Я відчував, як повітря вибиває з легень, поки я хапався руками за його чобіт" # "I could feel the air pushing out of my lungs as I put my hands weakly on his boot."
        n "Вінсент зціпив зуби й замахнувся бітою, безжально трощачи мою руку" with vpunch # "Vincent clentched his teeth and pulled the bat back, smashing my arm."
        $ health -=10
...
menu:
    ...
    "\"Ти не можеш мене відпустити?\"": # "Can't you let me go?"
        ...
        n "Довкола мене бігали медсестри й лікарі" # "There were nurses and doctors that roamed around me."
